        ...
        >
          <div className="bg-white/3 backdrop-blur-2xl p-10 rounded-4xl shadow-2xl relative">
            ...
            <form className="space-y-5">
              ...
              <button className="w-full bg-primary hover:bg-primary/90 text-black font-black py-5 rounded-[22px] flex items-center justify-center gap-2 transition-all uppercase tracking-widest mt-4 shadow-[0_15px_30px_rgba(254,176,93,0.25)]">
                Start Rescue <ArrowRight size={20} />
              </button>
            </form>
